...
* Select an item from the [issues list](https://github.com/micdijkstra/liquid/issues)
* Search the sources for FIXME and TODO comments.
* Improve the [code coverage](https://coveralls.io/github/micdijkstra/liquid?branch=master).

Review the [pull request template](https://github.com/micdijkstra/liquid/blob/master/.github/PULL_REQUEST_TEMPLATE.md) before you get too far along on coding.
...
```bash
godoc -http=:6060
open http://localhost:6060/pkg/github.com/micdijkstra/liquid/
```
